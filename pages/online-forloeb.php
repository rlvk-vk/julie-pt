...
<main>
	...
	<div class="twi">
		<div class="i" style="background-image: url('/assets/images/personlig-traening.jpg');">
			<div class="if"></div>
			<h2 class="ta-r">Du bestemmer selv og kan tilrettelægge forløbet efter dine ønsker og det der er rigtig for dig</h2>
		</div>
		<div class="c">
			...
			<button class="cta c">Start forløb</button>
		</div>
	</div>
	...
	<div class="t bg-d">
		...
		<button class="cta c">Skriv til mig</button>
	</div>

	<div class="twi">
		<div class="i" style="background-image: url('/assets/images/mere-frihed.jpg');">
			<div class="if"></div>
			<h2 class="ta-r">Mere frihed og træning efter dine behov og muligheder, hvorhen du befinder dig</h2>
		</div>
		<div class="c">
			...
			<button class="cta c">Book online forløb</button>
		</div>
	</div>
</main>
